...
from src.common_ops import stack_advanced_neat
from src.common_ops import stack_basic_neat
from src.common_ops import stack_lstm
from src.utils import get_train_ops

cell_dict = {"NAS": stack_lstm,
             "BasicNeat": stack_basic_neat,
             "AdvancedNeat": stack_advanced_neat}
...
class PTBEnasController(object):
            ...
            with tf.variable_scope("lstm"):
                ...
                for layer_id in xrange(self.lstm_num_layers):
                    with tf.variable_scope("layer_{}".format(layer_id)):
                        w = tf.get_variable("w", [2 * self.lstm_size, unit_size * self.lstm_size])
    ...
    def _build_sampler(self):
        ...
        for layer_id in xrange(self.rhn_depth):
            next_c, next_h = cell(inputs, prev_c, prev_h, self.w_lstm)
